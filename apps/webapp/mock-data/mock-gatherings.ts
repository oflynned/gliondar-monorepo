...
import { getRandomPerson, getRandomPeople } from './mock-people';

export const mockGatherings: Record<string, Gathering> = {
  '1': {
    id: '1',
...
export const mockEventDiscovery: {
  ...
  {
    timeframe: 'Today',
    gatherings: [mockGatherings['1']],
  },
  {
    timeframe: 'Tomorrow',
    gatherings: [mockGatherings['2'], mockGatherings['3']],
  },
  {
    timeframe: 'Later',
    gatherings: Object.values(mockGatherings),
  },
];
